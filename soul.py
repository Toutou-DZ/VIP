...
bot = telebot.TeleBot('7682268952:AAF1xO9ZCIrBvoROLee05J_LJNumjXOW13c')

# Admin user IDs
admin_id = {"1051421086", "12345667", "12345667"}
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 181:
                ...
                full_command = f"./soul {king} {soulking} {time} 300"
                subprocess.run(full_command, shell=True)
                response = f"-漫~*'¨¯¨'*·舞~ 🇮🇳ąɬɬąƈƙ ƈơɱ℘Ɩɛɬɛɖ🇮🇳 ~舞*'¨¯¨'*·~漫- king: {king} soulking: {soulking} soulking: {time}"
        else:
            response = "✅A͢v͢a͢i͢l͢a͢b͢l͢e͢ r͢i͢g͢h͢t͢ n͢o͢w͢✅ :- /soul <king> <soulking> <time>"  
    else:
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - https://t.me/+_IpGtBHKdm4xN2Y1 ."
